...
for(let i=0;i<20;i++){const base=40+i*5,p=[10,20,25,40,50][i%5],c=base*p/100;out.push({level:9+Math.floor(i/2),q:`${base} için yüzde ${p} hesabının sonucu kaçtır?`,correct:String(c),wrong:[String(c+5),String(c-5),String(c+10)]});}
